...
public class WaiterDashBoard implements DashBoard {
    ...
    public VBox viewReservations(){
        ...
        Label welcome = new Label("Welcome back " + waiter.getName());
        welcome.setFont(new Font(24));
        Label reservationsTitle = new Label("Today's Reservations:");
        reservationsTitle.setFont(new Font(20));

        TreeView<String> orderList = waiter.checkReservations(restaurant.getOrder().getOrders());
    ...
    public WaiterDashBoard(Restaurant restaurant, Waiter waiter, Stage window, Scene loginScene) {
